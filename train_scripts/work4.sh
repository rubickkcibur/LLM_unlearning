...
DATA_PATH="/aifs4su/rubickjiang/unlearning/data/self_generated_base/medmcqa/wrong_answer.jsonl"
DATASET_NAME="gsm8k"
VALID_DATA_PATH=""
OUTPUT_DIR="/aifs4su/rubickjiang/unlearning/models/gsm8k-base-lora-de-med-1vs8-001"
TEMP_PATH=""
...
do
    ...
    --output_dir "/aifs4su/rubickjiang/unlearning/models/gsm8k-base-lora-de-med-1vs8-${i}" \
