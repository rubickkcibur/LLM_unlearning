...
DATASET_NAME="gsm8k"
VALID_DATA_PATH=""
OUTPUT_DIR="/aifs4su/rubickjiang/unlearning/models/gsm8k-base-de-qasc-1vs4-001"
TEMP_PATH=""
...
do
    ...
    --output_dir "/aifs4su/rubickjiang/unlearning/models/gsm8k-base-de-qasc-1vs4-${i}" \
