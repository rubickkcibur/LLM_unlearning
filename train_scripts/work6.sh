...
#SBATCH -p batch
#SBATCH -J gsm8k_correct_answer
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=4
#SBATCH --gres=gpu:8
MODEL_PATH="/aifs4su/rubickjiang/huggingface_models/Meta-Llama-3-8B"
DATA_PATH="/aifs4su/rubickjiang/unlearning/data/self_generated_base/qasc/wrong_answer_shorter.jsonl"
DATASET_NAME="gsm8k"
VALID_DATA_PATH=""
OUTPUT_DIR="/aifs4su/rubickjiang/unlearning/models/gsm8k-base-de-qasc-shorter_answer"
TEMP_PATH=""
